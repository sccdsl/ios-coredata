...
/**
 iOS10新特性 NSPersistentContainer 将之前的NSManagedObjectContext，NSManagedObjectModel， NSPersistentStoreCoordinator 整合在一起了，它简化了创建一个新的CoreData堆。它维持了你项目中的NSManagedObjectModel ，NSPersistentStoreCoordinator 和其他资源的引用
 */
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            ...
            [_persistentContainer loadPersistentStoresWithCompletionHandler:^(NSPersistentStoreDescription *storeDescription, NSError *error) {
                ...
                NSLog(@"--->%@", [storeDescription.URL absoluteString]);
                if (error != nil) {
